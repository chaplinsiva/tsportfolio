...
export const Contact = () => {
  return (
    <div className='border-b border-neutral-900 pb-20'><motion.h2 whileInView={{opacity:1,y:0}}
    ...
    <div className='text-center tracking-tighter'>
        ...
        initial={{opacity:0,y:-100}}
        transition={{duration:1}} href="https://mail.google.com/mail/u/0/#compose" className='border-b'>{CONTACT.email}</motion.a></div></div>
  )
}
